...
- [M01_semantic.html](M01_semantic.html) — Demonstrates semantic HTML5 elements and basic page structure.
- [M02_canvas_basic.html](M02_canvas_basic.html) — Basic Canvas drawing example (trees, gradients, patterns).
- [M02_canvas_ampliat.html](M02_canvas_ampliat.html) — Expanded Canvas example with multiple objects and textures.
- [M02_canvas_animacio.html](M02_canvas_animacio.html) — Canvas animation example using requestAnimationFrame (sun/earth/moon).
- [escacs.html](escacs.html) — Simple chessboard drawn on a canvas.
- [M03_audio.html](M03_audio.html) — Audio playback controls and current-time display using the Audio API.
- [M04_video.html](M04_video.html) — Video element example with basic playback controls and time display.
- [M05_geolocalitzacio.html](M05_geolocalitzacio.html) — Geolocation demos using OpenLayers and mapping APIs.
